                      ...
                      <div class="flex-grow-1 mt-3 mt-sm-5">
                        ...
                        >
                          <div class="user-profile-info">
                            ...
                            >
                              <li class="list-inline-item"><i class="ti ti-color-swatch"></i> teacher</li>
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="courses1"
                        ><i class="ti-xs ti ti-layout-grid me-1"></i> courses</a
                      >
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="assignment" >
                            <i class="fa-sharp fa-solid fa-sheet-plastic me-1" ></i>Assignments</a>
                      </li>
                  </ul>
                </div>
              </div>
